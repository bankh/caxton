...
class ResidualAttentionModel_56(nn.Module):
    ...
    def __init__(self, retrieve_layers=False, retrieve_masks=False):
        ...
        self.fc = nn.Linear(2048, 4) #10 for Parameterclassifier / 4 for NoParameterClassifier
...
class ResidualAttentionModel_92(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc = nn.Linear(2048, 4) # 4 for NoParameterClassifier
        # self.fc = nn.Linear(2048,10) # 10 for Parameterclassifier
