...
from model.residual_attention_network import ResidualAttentionModel_56, ResidualAttentionModel_92
...
class ParametersClassifier(pl.LightningModule):
    def __init__(
        ...
        self.attention_model = ResidualAttentionModel_56(retrieve_layers=retrieve_layers, 
        ...
        self.train_acc0 = Accuracy()
        self.train_acc1 = Accuracy()
        self.train_acc2 = Accuracy()
        self.train_acc3 = Accuracy()
        self.val_acc = Accuracy()
        self.val_acc0 = Accuracy()
        self.val_acc1 = Accuracy()
        self.val_acc2 = Accuracy()
        self.val_acc3 = Accuracy()
    ...
    def validation_step(self, val_batch, batch_idx):
        ...
        loss = loss0 + loss1 + loss2 + loss3
        preds = torch.stack((preds0, preds1, preds2, preds3))
        # self.log('some_metric', some_value, reduce_fx="mean")
        self.log(
            "val_loss",
            loss,
            prog_bar=True,
...
class NoParametersClassifier(pl.LightningModule):
    def __init__(
        self,
        num_classes,
        lr=1e-3,
        ...
        self.lr = lr
        self.__dict__.update(locals())
        self.attention_model = ResidualAttentionModel_92()
        # self.attention_model = ResidualAttentionModel_56(retrieve_layers=retrieve_layers, 
        #                                               retrieve_masks=retrieve_masks
        # )
