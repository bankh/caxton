...
- [clean_csv.py](./utils/clean_csv.py) will take in the [process_log.txt](/process_log.txt) and remove the corresponding rows from the caxton_dataset_filtered.csv.
